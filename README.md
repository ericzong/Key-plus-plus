...
| ---------------------------- | -------------------------------- | ------------------------------------------------------------ |
| `ESC`                        | 退出脚本                         |                                                              |
| `F2`                         | 编辑主脚本                       | 如果配置文件中有指定 SciTE4AutoHotkey 编辑器的路径，则会使用它；否则，尝试使用 notepad++；否则，使用记事本。仅从源代码运行时可编辑主脚本，另见 [运行源代码](#运行源代码) 部分。 |
| `F5`                         | 重新加载脚本，即重启             |                                                              |
| `b`                          | Backspace                        |                                                              |
...
| `Shift` + `w`                | 显示所有隐藏窗口                 |                                                              |
| `Ctrl` + `Shift` + `Alt` + n | 切换小键盘锁定开关               | 初始关闭。开启状态各快捷键详见[小键盘快捷键](#小键盘快捷键)说明 |
| `Alt` + `d`                  | 最小化活动显示器中的所有窗口     | 【多显示器功能】活动显示器是指，鼠标所在的显示器。如果不能确定活动显示器，则会操作主显示器窗口或所有窗口 |
